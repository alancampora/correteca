          ...
          <ul>
            {trainings.map((training: Training, index: number) => (
              <li key={index} className="mb-4">
                <div className="text-md flex flex-row justify-between space-x-2 bg-indigo-600 p-2 text-bold">
                  <p className="text-orange-200 uppercase font-bold">{training.title}</p>
                  <p className="text-orange-200 uppercase font-bold">{new Date(training.date).toISOString().split("T")[0]}</p>
                </div>

                <div className="bg-indigo-50 px-2 flex justify-between items-center">
                  <div
